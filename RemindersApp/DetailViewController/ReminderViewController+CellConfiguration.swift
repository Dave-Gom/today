//
//  ReminderViewController+Configuration.swift
//  RemindersApp
//
...
extension ReminderViewController {
    ...
    func notesConfituration(for cell: UICollectionViewListCell, with notes: String?) -> TextViewContentView.Configuration {
